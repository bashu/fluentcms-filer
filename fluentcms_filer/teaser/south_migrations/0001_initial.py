...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contentitem_teaser_filerteaseritem', (
        ...
        db.send_create_signal(u'teaser', ['FilerTeaserItem'])


    def backwards(self, orm):
        # Deleting model 'FilerTeaserItem'
        db.delete_table(u'contentitem_teaser_filerteaseritem')
