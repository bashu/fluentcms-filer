...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contentitem_teaser_filerteaseritem', 'description', self.gf('fluent_contents.extensions.PluginHtmlField')(null=True))

    def backwards(self, orm):

        # Changing field 'FilerTeaserItem.description'
        db.alter_column(u'contentitem_teaser_filerteaseritem', 'description', self.gf('django.db.models.fields.TextField')(null=True))
